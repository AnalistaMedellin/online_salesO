...
const faqs = [
  ...
  { question: "¿Qué medios de pago y crédito manejan?", answer: "Manejamos pago de contado (transferencia, consignación) y opciones de crédito, evaluadas y acompañadas por el equipo financiero especializado de AutoVenz según el monto y la trayectoria comercial de tu almacén o flota. Tu Asesor Corporativo te guía en todo el proceso y te confirma qué modalidad aplica a tu cuenta antes de facturar." },
