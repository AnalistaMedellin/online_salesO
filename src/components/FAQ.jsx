...
const faqs = [
  ...
  { question: "¿Cuál es el monto mínimo de compra para acceder a los descuentos?", answer: "Para acceder a los descuentos de contado (CASH) y VIP, el ticket mínimo va desde $800.000 hasta $1.200.000 COP, dependiendo de la línea del portafolio que desees adquirir. Esto nos permite garantizar un flete rápido y eficiente." },
  ...
  { question: "¿Cómo accedo a la Comunidad VIP?", answer: "La Comunidad VIP se activa a través de tu Asesor Corporativo asignado, vinculando tu cuenta a lotes estratégicos con condiciones preferenciales y descuentos adicionales sobre el portafolio. El acceso se habilita según tu historial de recompra y volumen de negocio con AutoVenz, así que entre más constante seas por el canal digital, más rápido escalas de nivel y más beneficios exclusivos desbloqueas." },
  { question: "¿Qué medios de pago y crédito manejan?", answer: "Manejamos pago de contado (transferencia, consignación) y opciones de crédito, evaluadas y acompañadas por el equipo financiero especializado de AutoVenz según el monto y la trayectoria comercial de tu taller, almacén o flota. Tu Asesor Corporativo te guía en todo el proceso y te confirma qué modalidad aplica a tu cuenta antes de facturar." },
  { question: "¿Puedo mezclar línea nueva con lotes VIP en un mismo pedido?", answer: "Los pedidos de línea nueva y los lotes VIP se manejan por separado. Los lotes VIP son un beneficio exclusivo para la Comunidad VIP. Tu Asesor Corporativo te cuenta cómo acceder a la Comunidad VIP y qué opciones tienes disponibles." },
];
